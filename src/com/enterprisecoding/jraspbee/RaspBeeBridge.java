...
import com.enterprisecoding.jraspbee.exceptions.ApiException;
import com.enterprisecoding.jraspbee.exceptions.DeviceOffException;
import com.enterprisecoding.jraspbee.exceptions.EntityNotAvailableException;
import com.enterprisecoding.jraspbee.exceptions.GroupTableFullException;
import com.enterprisecoding.jraspbee.exceptions.InvalidCommandException;
import com.enterprisecoding.jraspbee.exceptions.InvalidJsonException;
import com.enterprisecoding.jraspbee.exceptions.LinkButtonException;
import com.enterprisecoding.jraspbee.exceptions.MethodNotAvailableException;
import com.enterprisecoding.jraspbee.exceptions.MissingParametersException;
...
public class RaspBeeBridge {
     ...
     */
    public RaspBeeBridge(String ip, String port) {
        this.ip = ip;
        this.port = port;
    }
    ...
    /**
     * Returns the Port of the bridge.
     *
     * @return port of bridge
     */
    ...
    public interface ScheduleCallback {
         ...
         */
        public void onScheduleCommand(RaspBeeBridge bridge) throws IOException, ApiException;
    }
            ...
            try {
                ...
                for (ErrorResponse error : errors) {
                    switch (error.getType()) {
                        ...
                        case 2:
                            throw new InvalidJsonException(error.getDescription());
                        case 3:
                            throw new EntityNotAvailableException(error.getDescription());
                        case 4:
                            throw new MethodNotAvailableException(error.getDescription());
                        case 5:
                            throw new MissingParametersException(error.getDescription());
                        case 6:
                            throw new ParameterNotAvailableException(error.getDescription());
                        case 7:
                            throw new InvalidCommandException(error.getDescription());
                        case 8:
                            throw new ParameterNotModifiableException(error.getDescription());
                        case 101:
    ...
    private String getRelativeURL(String path) {
        if (username == null) {
            ...
            return "http://" + ip + ":" + port + "/api/" + enc(username) + "/" + path;
        }
    }
}